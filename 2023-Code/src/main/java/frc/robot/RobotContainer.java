...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    return new ScoreMobilityThenBalance(m_driveTrainSubsystem, m_armPidController, m_armSubsystem, m_scoringSubsystem, m_intakeSubsystem, m_intakeManager, m_ledSubsystem, m_driverController, m_telescopeSubsystem)
