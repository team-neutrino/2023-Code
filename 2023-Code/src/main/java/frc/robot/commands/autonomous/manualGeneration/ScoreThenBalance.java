...
public class ScoreThenBalance extends SequentialCommandGroup {
  ...
  public ScoreThenBalance(DriveTrainSubsystem p_drivetrainSubsystem, ViennaPIDController p_pidController, ArmSubsystem p_armSubsystem, ScoringSubsystem p_scoringSubsystem) {
    ...
    addCommands(new ArmToAngleCommand(p_armSubsystem, p_pidController, ArmConstants.BACK_MID), new ScoringOpenCommand(p_scoringSubsystem, 2), forwardBackCommand, new AutoBalanceCommand(m_drivetrainSubsystem));
  }
}
