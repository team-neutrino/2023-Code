...
public class ScoreThenDriveForwardAuton extends SequentialCommandGroup {
  ...
  public ScoreThenDriveForwardAuton(DriveTrainSubsystem p_drivetrainSubsystem, ArmSubsystem p_armSubsystem, ViennaPIDController p_pidController, ScoringSubsystem p_scoringSubsystem) {
    ...
    m_driveForwardRamsete = new RamseteCommand(
    ...
    //addCommands(new ArmToAngleCommand(m_armSubsystem, m_pidController, ArmConstants.BACK_MID), new ScoringOpenCommand(m_scoringSubsystem), m_driveForwardRamsete);
    addCommands(new ArmToAngleCommand(m_armSubsystem, m_pidController, ArmConstants.BACK_MID), new ScoringOpenCommand(m_scoringSubsystem));
  }
}
