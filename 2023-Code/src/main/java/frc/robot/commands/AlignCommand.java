...
public class AlignCommand extends CommandBase {
  ...
  public void execute() {
    ...
    if (m_limelight.getTv()){
      ...
      if (array.length != 0){
        ...
        if (array[0] > 0){
        m_drivetrain.setMotors(array[0], array[0]);
        }
        else {
          m_drivetrain.setMotors(array[0] * -1, array[0] * -1);
        }
  ...
  private void m_drivetrain(double d) {
  }
