...
public class ColorSubsystem extends SubsystemBase {
  ...
  private final Color C_Violet = new Color(56, 115, 83);
  ...
  public ColorSubsystem() {
    ...
    m_colorMatcher.addColorMatch(C_Violet);
  ...
  public boolean isPurple(Color detectedColor) {
    ColorMatchResult matchResult = m_colorMatcher.matchClosestColor(detectedColor);
    return C_Purple.equals(matchResult.color) || C_Violet.equals(matchResult.color);
  }
